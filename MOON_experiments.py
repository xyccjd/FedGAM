...
for ep in [15]:
    ...
    def get_args():
        ...
        #for MOON
        parser.add_argument('--use_projection_head', type=bool, default=True, help='whether add an additional header to model or not (see MOON)')
        ...
        parser.add_argument('--logdir', type=str, required=False, default="./logs_SVHN_moon_beta=0.3/", help='Log directory path')
