...
for ep in [10,15]:
    ...
    def get_args():
        ...
        #for SAM
        parser.add_argument("--use_SAM", default=True, type=bool, help="True if you want to use SAM.")
        ...
        parser.add_argument('--logdir', type=str, required=False, default="./FedASAM_SVHN_logs_IID/", help='Log directory path')
