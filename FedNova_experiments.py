...
for ep in [15]:
    ...
    def get_args():
        ...
        parser.add_argument('--alg', type=str, default='fednova',
        ...
        parser.add_argument('--logdir', type=str, required=False, default="./fmnist_fednova_beta=0.3/", help='Log directory path')
