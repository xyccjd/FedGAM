...
for ep in [15]:
    ...
    def get_args():
        ...
        parser.add_argument('--beta', type=float, default=0.7, help='The parameter for the dirichlet distribution for data partitioning')  # 迪利克雷分布参数
        ...
        parser.add_argument('--logdir', type=str, required=False, default="./FedGAM_SVHN_logs_Beta=0.7/", help='Log directory path')
